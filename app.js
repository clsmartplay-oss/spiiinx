(function () {
  ...
  const CIUDADES = ['Montevideo', 'Salto', 'Paysandú', 'Las Piedras', 'Rivera', 'Maldonado', 'Tacuarembó', 'Melo', 'Mercedes', 'Artigas', 'Minas', 'San José de Mayo', 'Durazno', 'Florida', 'Treinta y Tres', 'Rocha', 'Colonia del Sacramento'];

  const TIEMPOS = ['hace 5 min', 'hace 12 min', 'hace 1 hora', 'hace 2 horas', 'hace 30 min'];

  const STORAGE_KEY = 'smartplay_spun';
  ...
  function updateWhatsAppLink() {
    ...
    var text = bonus != null
      ...
      : 'Hola, quiero reclamar mi b0n0 de la rule74 SmartPlay.';
